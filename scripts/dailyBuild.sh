...
sed -i "s;FROM icr.io/appcafe/open-liberty:full-..JAVA_VERSION.-openj9-ubi;FROM $DOCKER_USERNAME/olguides:$BUILD;g" system/Dockerfile graphql/Dockerfile query/Dockerfile
