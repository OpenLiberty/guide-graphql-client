...
public class QueryResourceIT {
    ...
    private static String system8ImageName = "system:1.0-java17-SNAPSHOT";
    ...
    public static GenericContainer<?> systemContainer
        = new GenericContainer<>(system8ImageName)
              ...
              .withNetworkAliases("system-java17")
    ...
    public void testGetSystem() {
        System.out.println("TEST: Testing get system /system/system-java17");
        SystemInfo systemInfo = client.querySystem("system-java17");
        assertEquals(systemInfo.getHostname(), "system-java17");
    ...
    public void testGetSystemLoad() {
        System.out.println("TEST: Testing get system load /systemLoad/system-java17");
        List<SystemLoad> systemLoad = client.querySystemLoad("system-java17");
        assertEquals(systemLoad.get(0).getHostname(), "system-java17");
    ...
    public void testEditNote() {
        ...
        note.setHostname("system-java17");
